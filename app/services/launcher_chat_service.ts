...
export default class LauncherChatService {
  ...
  public static async receivedUserStatusConnected(message: string, natsService: NatsService): Promise<void> {
    ...
    const { default: ChatUserStatusConnectedService } = await import('App/Services/ChatUserStatusConnectedService')
    ...
    for (const friend of friends) {
      const friendStatus: string = await ChatUserStatusConnectedService.getUserStatus(friend.friend_users_id)
  ...
  public static async receivedChatFriendRequest(message: string, natsService: NatsService): Promise<void> {
    ...
    const { default: ChatFriendRequestService } = await import('App/Services/ChatFriendRequestService')
    const { default: ChatFriendService } = await import('App/Services/ChatFriendService')
  ...
  public static async receivedChatMessage(message: string, natsService: NatsService): Promise<void> {
