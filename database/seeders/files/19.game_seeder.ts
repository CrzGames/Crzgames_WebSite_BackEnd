  ...
  public async run(): Promise<void> {
    ...
    const fakeGames: FakeGame[] = [
      ...
      },
      {
        ...
        gamePlatforms: ['Windows', 'macOS', 'Linux', 'Xbox Series X|S'],
      ...
      },
      {
        ...
        logoFile: path.join(assetsBasePath, 'diablo4-logo.webp'),
        gamePlatforms: ['Windows', 'macOS', 'Linux', 'iOS', 'Android'],
        ...
        recommended_config: {
          cpu_intel: 'Intel Core i5 3470',
          cpu_amd: 'AMD FX-8350',
          gpu_nvidia: 'NVIDIA GTX 660 2GB',
          gpu_amd: 'AMD HD 7870 2GB',
          ram: '16GB',
          storage: '60GB',
          os: 'Windows 10+',
          internet: false,
